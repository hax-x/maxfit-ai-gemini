...
const prop = (a: unknown, prop: string, _kind: string = 'object') =>
  a !== null &&
  typeof a === 'object' &&
  prop in a &&
...
export const isToolCallMessage = (a: unknown): a is ToolCallMessage => prop(a, 'toolCall')
...
export const isInterrupted = (a: unknown): a is Interrupted => (a as Interrupted).interrupted
...
export const isToolCallCancellation = (
  ...
  typeof a === 'object' && Array.isArray((a as Record<string, unknown>).ids)
