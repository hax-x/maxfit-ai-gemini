 ...
 */
const MediaStreamButton = memo(({ isStreaming, start, stop }: MediaStreamButtonProps) =>
  isStreaming ? (
    ...
    <section className="control-tray">
      ...
      <div className={cn('connection-container', { connected })}>
        ...
        <div className="connection-button-container">
          <MediaStreamButton isStreaming={connected} start={connect} stop={disconnect} />

          <div className="powered-by">
            Powered by{' '}
            <a
              href="https://easyai.us"
              target="_blank"
